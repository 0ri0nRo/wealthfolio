...
describe("Traditional Chinese translations", () => {
  ...
  it("uses Taiwan terminology instead of Mainland Chinese variants", () => {
    const prohibitedTerms = ["賬", "轉賬", "對映", "添加", "創建", "自定義", "數據", "默認", "獲取", "當前", "此處", "點選", "重置", "模板", "響應", "退出登入", "儀表盤", "未找到", "程式碼", "通過", "返佣", "佣金", "占比", "周期", "周", "余額", "校驗", "跟蹤", "通脹", "供款", "收益率", "構建", "對比", "常規", "高階", "提供商", "期權", "倉位", "情景", "養老", "提取", "增長", "訪問", "例項", "令牌", "許可權", "作用域", "運行", "新建", "移動端", "檢測", "請求頭", "總體", "識別"];
