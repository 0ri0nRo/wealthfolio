...
pub use assets_model::{
    ...
    instrument_default_multiplier, normalize_quote_ccy_code, resolve_import_quote_ccy_precedence,
    resolve_quote_ccy_precedence, Asset, AssetKind, AssetMetadata, AssetProfile, AssetSpec,
