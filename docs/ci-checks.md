...
| Cargo manifests/lockfile, toolchain, build scripts, shared Tauri integration, `crates/http/` | Full Android APK and unsigned iOS device/simulator archives |
| Android project, icons, configuration, capabilities                                          | Full Android APK only                                       |
| iOS project, icons, configuration, capabilities                                              | Unsigned iOS archives only                                  |
